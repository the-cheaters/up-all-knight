...
RSpec.describe EnrollmentsController, type: :controller do
  ...
  let(:game) { FactoryGirl.create(:game, white_player_id: white_player.id, black_player_id: nill) }

  describe 'enrollments#create' do
    it 'should successfully enroll a player in a game' do
      game = FactoryGirl.create(:game, white_player_id: white_player.id, black_player_id: nil?)
